...
public class PayMentGateWay extends Activity {
    ...
    static String getFirstName, getNumber, getEmailAddress, getRechargeAmt,gettotaltextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      // getRechargeAmt  = oIntent.getExtras().getString("RECHARGE_AMT");
        gettotaltextView=oIntent.getExtras().getString("TEXT_PRICE");
        ...
        params.put("key", merchant_key);
          params.put("amount",gettotaltextView);
